...
These metrics are based on established definitions from the literature and the reference implementations in scikit-mobility. 
https://scikit-mobility.github.io/scikit-mobility/reference/measures.html


.. autoclass:: MobilityMetricsCalculator
   :members:
