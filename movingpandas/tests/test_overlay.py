...
class TestOverlay:
    ...
    def test_clip_one_intersections(self):
        ...
        assert intersections.get_trajectory('1_0') == \
    ...
    def test_clip_two_intersections_with_same_polygon(self):
        ...
        assert intersections.get_trajectory('1_0') == \
               make_traj([Node(5, 0, second=5), Node(6, 0, second=6), Node(7, 0, second=7)], id='1_0', parent=traj)
        assert intersections.get_trajectory('1_1') == \
    ...
    def test_intersection_with_feature(self):
        ...
        intersection = self.default_traj_metric_5.intersection(feature).get_trajectory('1_0')
        assert len(intersection.df.columns) == len(['geometry', 'value', 'intersecting_id', 'intersecting_name'])
